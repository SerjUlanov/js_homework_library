...
let ar16 = [0, 2, 5, -4, 6, 22, -9, -12, 8, 12, 13, 78, 16, 25, 91, 1, 99, 1952];
let ar16_odd = [];
let ar16_even = [];
...
function f16() {
    ...
    // let out_1 = "";
    // let out_2 = "";
    // //разделяем массив ar16 на чётный и нечётный массивы
    // for (let i = 0; i < ar16.length; i++) {
    //     if (ar16[i] % 2 == 0) {
    //         ar16_even.splice(i, 0, [ar16[i]])
    //     } else {
    //         ar16_odd.splice(i, 0, [ar16[i]])
    //     }
    // }
    ...
    document.querySelector('.out-16-odd').innerHTML = out_1;
    document.querySelector('.out-16-even').innerHTML = out_2;
}
