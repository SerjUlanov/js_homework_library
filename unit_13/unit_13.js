...
function f6() {
    let i_1 = document.querySelector(".i-61").value
    let i_2 = document.querySelector(".i-62").value
    a6[i_1] = i_2;
    f5(a6, '.out-6');
...
function f13() {
    ...
    let summ = 0;
    for (let key in a13) {
        if (typeof a13[key] != "string") {
            summ = summ + a13[key];
        }
    }
    out.textContent = summ
}
...
function f17() {
    ...
    let out_1 = "";
    for (let key in a17) {
        if (a17[key].age > 30) out_1 += a17[key].name + " ";
    }
    out.textContent = out_1;
}
...
function f18() {
    ...
    let i = document.querySelector(".i-18");
    let out_1 = "";
    for (let key in a18) {
        if (key == i.value) {
...
function f19() {
    ...
    for (let key in a19) {
        for (let i = 0; i < a19[key].length; i++) {
            if (a19[key][i].toUpperCase() == input.value.toUpperCase()) {
                out_1 = key;
            }
        }
    }
