...
function f5() {
    ...
    out_5.textContent = out_4.classList.contains("bg-orange")
    // if (out_4.classList.contains("bg-orange")) {
...
function f8() {
    for (let i = 0; i < blocks8.length; i++) {
        blocks8[i].classList.add("bg-orange")
    }
}
...
let a_12 = document.createElement("div");
function f12() {
    let out = document.querySelector(".out-12");
    a_12.textContent = 12;
    a_12.classList.add("bg-orange")
    out.append(a_12);
}
...
let a_13 = document.createElement("div");
function f13() {
    let out = document.querySelector(".out-13");
    a_13.textContent = "Push me";
    a_13.classList.add("bg-orange")
    out.append(a_13);
}
a_13.onclick = f13_1;
function f13_1() {
...
let a_14 = document.createElement("div");
function f14() {
    let out = document.querySelector(".out-14");
    a_14.textContent = 14;
    a_14.classList.add("bg-orange")
    out.append(a_14);
}
...
let a_15 = document.createElement("div");
function f15() {
    let out = document.querySelector(".out-15");
    a_15.textContent = 15;
    a_15.classList.add("bg-orange")
    out.before(a_15);
}
...
let a_16 = document.createElement("div");
function f16() {
    let out = document.querySelector(".out-16");
    a_16.textContent = 16;
    a_16.classList.add("bg-orange")
    out.after(a_16);
}
...
let a_17 = document.createElement("div");
let a_17_1 = document.createElement("div");
function f17() {
    let out = document.querySelector(".out-17");
    a_17.textContent = 17;
    a_17_1.textContent = 115;
    a_17.classList.add("bg-orange")
    out.replaceWith(a_17, a_17_1);
}
...
function f19() {
    ...
    for (let i = 0; i < p.length; i++) {
        out_f += p[i].getAttribute("data-b") + " ";
    }
    out.textContent = out_f
}
