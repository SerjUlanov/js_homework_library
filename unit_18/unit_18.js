...
function t5() {
    //обнуляем итоговый массив при каждой итерации
    //и ловим элементы со страницы
    a5_res = []
    let spans = document.querySelectorAll(".task-5");
    //добавляем событие .onclick ко всем элементам spans
    //.addEventListener() - метод добавления обработчика
    spans.forEach(elem => elem.addEventListener("click", t5))
    //добавляем значение атрибута data кликнутого (ЭТОГО/this)
    //элемента в массив a5_res
