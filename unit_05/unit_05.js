...
function t8() {
   ...
   let f_out = "";
   let input_1 = +document.querySelector(".i-81").value;
   let input_2 = +document.querySelector(".i-82").value;
...
function t14() {
   ...
   for (let i = 0; i < inputs.length; i++) {
      if (inputs[i].checked) {
         out.textContent = inputs[i].value;
      }
   }
}
