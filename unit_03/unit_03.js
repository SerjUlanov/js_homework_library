...
function f3(){
   ...
   console.log(input2);
   if ( input1 > input2){
      document.querySelector(".out-3").textContent = input1;
   }else{
      document.querySelector(".out-3").textContent = input2;
   }
...
function f7(){
   ...
   document.querySelector(".out-7").textContent = input1**input2;
...
function f11(){
   ...
   console.log(select);
   select.onchange = document.querySelector(".out-11").textContent = select;
}
...
function f14(){
   ...
   switch (select) {
      case "+":
         document.querySelector(".out-14").textContent = input1+input2;
         break;
      case "-":
         document.querySelector(".out-14").textContent = input1-input2;
         break;
...
if (select1 == 1 && select2 == 1 && select3 == "&&" || select3=="||"){
   out.textContent = 1;
} else if (select1 == 0 && select2 == 0 && select3 == "&&" || select3=="||") {
   out.textContent = 1;
}  else if (select1 == 0 && select2 == 1 && select3=="||") {
   out.textContent = 1;
}  else if (select1 == 1 && select2 == 0 && select3=="||") {
   out.textContent = 1;
} else {
   out.textContent = 0;
}
