...
function f5() {
    ...
    if (checkBox.checked) {
        out.textContent = checkBox.value;
    } else {
        out.textContent = false;
    }
}
...
function f7() {
    let out_1 = document.querySelector(".out-71");
    let out_2 = document.querySelector(".out-72");
    let input = document.querySelector(".i-7");
    out_1.textContent = input.value;
...
function f11() {
    let input_1 = document.querySelector(".i-111");
    let input_2 = document.querySelector(".i-112");
...
function f20() {
    let select_1 = document.querySelector(".s-201");
    let select_2 = document.querySelector(".s-202");
    select_1.onchange = () => {
        if (select_1.value == "one") {
            select_2.value = "one";
            console.log(select_1.value);
            console.log(select_2.value);
        } else if (select_1.value == "two") {
            select_2.value = "two";
            console.log(select_1.value);
            console.log(select_2.value);
        } else {
